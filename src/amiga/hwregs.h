...
#define REG_DSKPTH		REG(REGN_DSKPTH)
#define REG_DSKPTL		REG(REGN_DSKPTL)
#define REG32_DSKPT		*(volatile uint32_t*)(REG_BASE_ADDR | REGN_DSKPTH)
#define REG_DSKLEN		REG(REGN_DSKLEN)
#define REG_DSKSYNC		REG(REGN_DSKSYNC)
...
enum {
	ADKCON_FAST		= 0x0100,
	ADKCON_MSBSYNC	= 0x0200,
	ADKCON_WORDSYNC	= 0x0400,
	ADKCON_UARTBRK	= 0x0800,
	ADKCON_MFMPREC	= 0x1000
};
#define ADKCON_PRECOMP_MASK	0x6000

enum {
	DSKLEN_WRITE	= 0x4000,
	DSKLEN_DMAEN	= 0x8000
};
#define DSKLEN_LENMASK	0x3fff
